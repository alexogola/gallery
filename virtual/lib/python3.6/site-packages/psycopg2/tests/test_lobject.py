...
from .testutils import (unittest, decorate_all_tests, skip_if_tpc_disabled,
    ConnectingTestCase, skip_if_brown, slow)
...
skip_lo_if_brown = skip_if_brown("libpq doesn't support LO in async mode")
...
decorate_all_tests(LargeObjectTests, skip_if_no_lo, skip_lo_if_brown)
...
decorate_all_tests(LargeObjectTruncateTests,
    skip_if_no_lo, skip_lo_if_brown, skip_if_no_truncate)
...
decorate_all_tests(LargeObject64Tests,
    skip_if_no_lo, skip_lo_if_brown, skip_if_no_truncate, skip_if_no_lo64)
...
decorate_all_tests(LargeObjectNot64Tests,
    skip_if_no_lo, skip_lo_if_brown, skip_if_no_truncate, skip_if_lo64)
